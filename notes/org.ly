...
KyrieBassFigures = \figuremode {
  ...
  <6>2 <6 5>4 q %20
  q q q <6>8 <6 5>
  r4 <5>8 <6!> r4 \bo <[5]>8 \bc <[6]>
  <4 [2]> <6> <4 2> <6> \bo <4 [2!]> \bc <6 [_!]> <4 2> <6>
  <[4!] 2> <6> r <6!> r4. <7 [_+]>8
  <_!>4. <6 [_!]>8 \bo <[7]>4 \bc <[7] _!> %25
  \bo <[7 \l]> <7 5!> \bc <[7 \l]>8 <_-> <5> <6>
  r <[6]> r <7 _!> \bo <[4]>4 \bc <[3]>
  \bo <6 [5]>8 <_!> <6 5!> <3> <6! 5> <5!> \bc <6 [5]>4
  q4. <7 _+>8 <[_!]>2
  r1 %30
  r2.. <3>8
  \bo <6 [5]> <_!> \bc <6 [5!]> <3> \bo <[6!] 5> \bc <[5!]> <6 5>4
  q q8 <_!> r2
  ...
  r4. <6>8 r q <_!> <6 [_!]>
  r <[4+ 2]> <6>4 <[5!] _+>4. <[6]>8
  <6 5>4 \bo <6 5 [_!]> <6 5>8 \bc <6 5 [_!]> <[9]> <3>
  <6! 5>4 <[5!] _+>2 r8 <[6]>
  <6 5>4 \bo <6 5 [_!]> <6 5>8 \bc <6 5 [_!]> \bo <[9]> \bc <[3]> %45
  <6! 5>4 <[5!] _+>2.
  r1*5 %51
  \bo <[8]>4. \bc <[7-]>8 <5>4. <[6 4!]>8
  <6>2 r8 q r <6 5>
  r4 \bo <[6]>8 \bc <[5]> r4 <6>8 <6 [_-]>
  r4 <6>8 <5> <_!>2 %55
  r <5>4 <6>
  <4 2>8 <6> <4 2> <6> <4 2> <6> <4 2> <6>
  r \bo <[6 \l]> \bc <[6 5]>2.
  \bo <6 [5]>4 <6 5> q \bc <6 [5]>
  q <6 5> <3>2 %60
  <6 5>4 q q q
  q q2.
  r4. <6>8 <6 5>2
...
GloriaBassFigures = \figuremode {
  ...
  r2 <7>4 <5-> %100
  r <6-> r8 <6!>4.
  <[6]>4 \bo <7 [4]>8 \bc <6 [\t]> <6 5>4 \bassFigureExtendersOn <6 4!>8. q16 \bassFigureExtendersOff
  <6>2 <2>4 <6>
  <6> <_+> <[6! 4] 2> <6\\>8 <[_+]>
  \bo <[6]>4 \bc <[_!]> <7> <6 5!> %105
  r1
  \bo <[6 5]>2 <6 5>4 \bc <[_! \l]>
  r2. <3>4
  r <6!>2.
  r4. <[6]>8 r2 %110
  r4 <6> <6 5> <[7-]>
...
CredoBassFigures = \figuremode {
  ...
  <6>
  <6 5>4 <5! 4> <\t _+>
  r4. \bo <[6! \l]>8 \bc <[7 5!] _+>4
  <_!>2.
  \bo <[6 4]>2 \bc <[7 \l]>4 %125
  r2.
  r4 \bo <[6 \l]> <7>
  <_-> <6 5> \bc <[_- \l]>
  r2.
...
SanctusOrgano = {
  \relative c {
    ...
    r16 \mvTr f,\fE-\tutti a c f c a c f,4 r
...
BenedictusBassFigures = \figuremode {
  r4. <6>8 <7>4 <6>
  r8 \bo <[6 \l]> \bc <[6 5]>4 \bo <9 [4]> <8 3>8 \bc <6 [5-]>
  <9>4 <8> <6 5>2
  <7>4 <6> <4 2>8 <6> <[6 5]>4
  r <[6]> <[7] 4>4 <\t 3>8 \bo <[6 4]> %5
  <5 3>4 <7> <9 4> \bc <[8 3]>
  <6 5>8 <[7 _!]> r4 <6 5>4 q
  r <6> <9> <8>
  <6 5>8 \bo <[7 _!]> r <6 5> <6 4>4 <5 4>8 \bc <[\t _!]>
  r4 <6> <7> <6>8 <\t> %10
  <_!>4 <5>8 <6 4> <6 5>4 <_!>
  ...
  r4 \bo <[6 \l]> <7 4> <\t _!>8 <6 4>
  <5 _!>4 <6 5>8 <7 _!> <9 4>4 \bc <[6 \l]>
  <9> <8> \bo <[4]>8 \bc <[3]>4.
  r4. \bo <[6 \l]>8 <7 4>4 <\t 3>8 <6 4>
  <5 3>4 <7> <4> <3>8 \bc <[6 \l]> %20
  <9>4 <8> \bo <[6 5]>4. \bc q8
...
AgnusDeiBassFigures = \figuremode {
  ...
  r2 <[6]>
  r2. <6 5>4
  \bo <[9] 4>4 <8 3>8 <7! 2> \bc <[8] 3>2
  \bo <6\\ [4]>4 \bassFigureExtendersOn <6\\ 5>2 \bc <6\\ [4]>4 \bassFigureExtendersOff %5
  r2 <6\\>
  <6 4> <5! 4>4 <[\t _+]>
  r1
  r4 <4 2> <6> <6 _->
  ...
  r2 <6>
  r <6 5>
  \bo <[9 4]>4 <8 3>8 <7 2> \bc <[8 3]>2 %20
  <6 5> <\t \t>
  \bo <[9] 4>4 <8 3>8 <7! 2> \bc <[8] 3>2
  r1
  r
